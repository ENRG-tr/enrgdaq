...
class TestDAQJobXiaomiMijia(unittest.TestCase):
    ...
    def test_connect_with_retries_fail_then_success(
        self, mock_sleep, mock_client_context_cls
    ):
        ...
        self.job._logger.debug.assert_any_call(
    ...
    def test_connect_with_retries_all_fail(self, mock_sleep, mock_client_context_cls):
        ...
        self.assertEqual(
            mock_client_context_cls.call_count, self.config.connect_retries
        )
